  ...
  const items = [
...

    {
      label: (
        <a
          className="_link"
          href="https://quizer-frontend.vercel.app/attempt-survey/Report-a-Problem/66890a1b6495c447b5476e98"
          target="_"
        >
          Report a Problem
        </a>
  ...
  return (
    <>
      <div className="pb-2 pt-2 border-bottom d-flex flex-row justify-content-between align-items-center ">
        {!breakpoints.lg && (
          <MenuOutlined onClick={() => setDrawerVisibility(true)} />
        )}
        ...
        >
          {from === "subscriber" ? (
            <div className="d-flex align-items-center gap-4">
              ...
              <div>
                <Dropdown menu={{ items }} trigger={["click"]} arrow>
                  <div
                    role="button"
                    className="d-flex flex-row justify-content-center align-items-center gap-1 px-1"
                  >
            ...
            <span
              role="button"
              onClick={() => router("/subscribe/quizzes")}
              className="d-flex flex-row justify-content-center align-items-center gap-1  px-1 "
            >
              <IoLogOutOutline size={16} />{" "}
              <span className="d-none d-md-block">Exit</span>
            </span>
          )}
        </div>
      </div>
